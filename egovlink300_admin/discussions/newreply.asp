...
If Request.Form("_task") = "newr" Then
  Set oCmd = Server.CreateObject("ADODB.Command")
  With oCmd
    .ActiveConnection = Application("DSN")
    .CommandText = "NewDiscussionReply"
    ...
    .Parameters.Append oCmd.CreateParameter("ParentID", adInteger, adParamInput, 4, Request.Form("ParentID"))
    .Parameters.Append oCmd.CreateParameter("RootID", adInteger, adParamInput, 4, Request.Form("RootID"))
    .Execute
  End With
  Response.Redirect "../discussions/thread.asp?tid=" & Request.QueryString("tid") & "&tp=" & Request.QueryString("tp") & "&mid=" & Request.QueryString("mid") & "&mp=1"
Else
  sTopic = Request.QueryString("topic")
End If
...
<body bgcolor="#ffffff" onmouseover="doMouseOver();" onmouseout="doMouseOut();" onload="doLoad();" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
  ...
  <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      ...
      <td><font size="+1"><b> Reply To Message: <%= sTopic %></b></font><br><img src="../images/arrow_2back.gif" align="absmiddle">&nbsp;<a href="javascript:history.back();"><%=langBackToTopic%></a></td>
      <td width="200">&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">
      ...
      <td colspan="2" valign="top">
        <form name="frmNewReply" action="newreply.asp?<%= Request.QueryString() %>" method="post">
          <input type="hidden" name="_task" value="newr">
          <input type="hidden" name="Message">
          <input type="hidden" name="DiscGroupID" value="<%= Request.QueryString("tid") %>">
          <input type="hidden" name="ParentID" value="<%= Request.QueryString("msgid") %>">
          <input type="hidden" name="RootID" value="<%= Request.QueryString("mid") %>">

          <div style="font-size:10px; padding-bottom:5px;"><img src="../images/cancel.gif" align="absmiddle">&nbsp;<a href="javascript:history.back();"><%=langCancel%></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/go.gif" align="absmiddle">&nbsp;<a href="javascript:document.all.Message.value = document.all.edit.innerHTML; document.all.frmNewReply.submit();"><%=langSendReply%></a></div>
          <table width="100%" cellpadding="5" cellspacing="0" border="0" class="tableadmin">
            <tr>
              <th align="left" colspan="2"><%=langReplyToMessage%>: <%= sTopic %></th>
            </tr>
            <tr>
              <td style="color:#336699;" width="15"><br><b>Topic:&nbsp;&nbsp;&nbsp;</b><br><br></td>
              <td><br><input type="text" name="Topic" size="50" value="<% If Left(sTopic,len(langRe)) <> langRe Then Response.Write langRe & " " & sTopic Else Response.Write sTopic %>"><br><br></td>
            </tr>

          <% If (dVer < 5.5) Then %>

            <tr>
              <td colspan="2"><font color="#336699"><b><%=langMessage%>:</b></font><br><textarea name="edit" rows="10" style="width:100%;"></textarea></td>
            </tr>
            </table>
          ...
          <div id="winFontColor" class="window" style="position:absolute; top:306px; left:504px; visibility:hidden;" onmouseout="if (!this.contains(event.toElement)) checkIn('');">
          ...
          <% End If %>
		  <div style="font-size:10px; padding-top:5px;"><img src="../images/cancel.gif" align="absmiddle">&nbsp;<a href="javascript:history.back();"><%=langCancel%></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/go.gif" align="absmiddle">&nbsp;<a href="javascript:document.all.Message.value = document.all.edit.innerHTML; document.all.frmNewReply.submit();"><%=langSendReply%></a></div>
        </form>
      </td>
    </tr>
  </table>
