...
If Request.Form("_task") = "newt" Then
  ...
  With oCmd
    ...
    .Execute
  End With
  Response.Redirect "../discussions/topics.asp?tid=" & Request.Form("DiscGroupID") & "&tp=1&gn=" & Request.Form("gn")
End If
...
<body bgcolor="#ffffff" onmouseover="doMouseOver();" onmouseout="doMouseOut();" onload="doLoad();" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
  ...
  <table border="0" cellpadding="10" cellspacing="0" width="100%">
    <tr>
      ...
      <td><font size="+1"><b><%=langTopicNewFirstMessage%></b></font><br><img src="../images/arrow_2back.gif" align="absmiddle">&nbsp;<a href="javascript:history.back();"><%=langBackToTopicsList%></a></td>
      <td width="200">&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">
