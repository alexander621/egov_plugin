...
Sub ShowRentalCategories( )
	...
	Do While Not oRs.EOF 
		...
		End If 
		response.Write vbcrlf & "<p><div class=""rentalcategorygroup"" onClick=""location.href='" & sGoTo & ".asp?categoryid=" & oRs("recreationcategoryid") &"';"">"
		response.write "<table class=""rentalcategory"" cellpadding=""0"" cellspacing=""0"" border=""0""><tr><td valign=""top"">"
		If oRs("imgurl") <> "" Then 
			response.Write vbcrlf & "<a href=""" & sGoTo & ".asp?categoryid=" & oRs("recreationcategoryid") & """><img class=""categoryimage"" align=""left"" src=""" & oRs("imgurl") & """></a>"
		End If 
