...
function print_card(pMID)
 ...
 'determine if this is the first time that a card has been printed
  sSqlt = "SELECT card_printed, printed_count FROM egov_poolpassmembers WHERE memberid = " & clng(pMID)
...
'------------------------------------------------------------------------------
sub createCardLayout(iTitle, iSubTitle, iYearText, iDisplayDate, iCustomImageURL, iQuote, iColor1, iColor2, iTextColor1, _
                     iTextColor2, iBackText, iBackTextColor, iLayoutName, iAction, iIsDisabled, iConfirmSoundFile)
...
'------------------------------------------------------------------------------
sub updateCardLayout(iCardID, iTitle, iSubTitle, iYearText, iDisplayDate, iCustomImageURL, iQuote, iColor1, iColor2, iTextColor1, _
                     iTextColor2, iBackText, iBackTextColor, iLayoutName, iIsDisabled, iConfirmSoundFile)
...
'------------------------------------------------------------------------------
sub alreadyExists(iCardID, iTitle, iSubTitle, iYearText, iDisplayDate, iCustomImageURL, iQuote, iColor1, iColor2, iTextColor1, _
                  iTextColor2, iBackText, iBackTextColor, iLayoutName, iIsDisabled, iConfirmSoundFile)
...
'------------------------------------------------------------------------------
sub displayCardLayoutOptions(iCardID,iShowOnlyActive)
...
'------------------------------------------------------------------------------
function checkDuplicateLayoutName(iCardID,iLayoutName)
  lcl_return = False
...
'------------------------------------------------------------------------------
function getOriginalLayoutName(iCardID,iOriginalLayout)
  i          = ""
...
'------------------------------------------------------------------------------
function checkMemberIDScanned(iMemberID,iRateID)
  lcl_return = False
