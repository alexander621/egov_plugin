...
'Set up Session variable for DISPLAY include file.
 ...
 sPrintCardURL = "image_display_new.asp"
...
function card_print() {
  ...
  var lcl_url_display  = 'image_display_new.asp';
...
function retake_picture() {
  var lcl_url_retake  = 'image_takepic_new.asp';
...
function remove_image() {
  var lcl_url_remove  = 'image_display_new.asp';
...
function card_save() {
  ...
  var lcl_url_save  = 'image_display_new.asp';
