...
'------------------------------------------------------------------------------
	...
	Public Sub Save(path)
		...
		For Each fileItem In UploadedFiles.Items
			...
			filename = request.querystring("userid") & ".jpg"
			...
			streamFile.SaveToFile path & filename, 2
			streamFile.close
...
'------------------------------------------------------------------------------
	Private Sub Upload()
		...
		if Err.Number <> 0 then 
  			response.write "<br /><br /><p><strong>System reported this error:</strong></p>"
     ...
     response.write "  Please see instructions in the <a href='http://www.ImageUpload.net/ImageUpload/requirements.asp'>requirements page of ImageUpload.net</a>."
     response.write "</p>"
			  exit sub
		end if
