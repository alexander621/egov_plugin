  ...
  If IsObject(objDir) And Err.Number = 0 Then
    ...
    If Not oRst.EOF Then
      Do While Not oRst.EOF
        ...
        If Left(name,1) <> "_" Then   'if dir starts with underscore that means it is hidden
          ...
          End If
          strNav = strNav & "<li style=""position:relative;"" nodeType=""c"" id=""" & newpath & """ class=""kid"">"
          strNav = strNav &   "<img style=""filter:alpha(opacity=100);"" src=""" & icon &""" width=""18"" height=""18"" align=""absmiddle"" />&nbsp;"
          strNav = strNav &   "<a href=""loadtree.asp?path="& newPath & """ target=""explorer"" title=""" & name & """>" & name & "</a>"
          strNav = strNav &   "<ul class=""hdn""></ul>"
    ...
    For Each objFound In objDir.Files
      ...
      'CODE FOR FILES
       ...
       strNav = strNav & "<li style=""position:relative; filter: Alpha(opacity=50);"" nodeType=""a"" id=""" & url & """>"
       strNav = strNav & "  <img class=""clsNoHand"" style=""filter:alpha(opacity=100);"" src=""" & imgSrc & """ width=""16"" height=""16"" align=""absmiddle"" />&nbsp;"
       strNav = strNav & "  <a title=""" & temp & """ href=""#"" onclick=""parent.document.all.FilePath.value='" & name & "'"">" & temp & "</a>"
       strNav = strNav & "</li>"
    ...
    if strNav = "" then
       strNav = "<li>"
       strNav = strNav & "<font color=""#003366"">"
       strNav = strNav & "<img src=""../../images/spacer.gif"" width=""0"" height=""18 ""align=""absmiddle"" />"
       strNav = strNav & "&nbsp;&nbsp;&nbsp;&nbsp;<i>(Empty)</i>"
       strNav = strNav & "</font>"
       strNav = strNav & "</li>"
    ...
    If Not oRst.EOF Then
      Do While Not oRst.EOF
        ...
        If Left(name,1) <> "_" Then   'if dir starts with underscore that means it is hidden
         ...
         strNav = strNav & "<li style=""position:relative;"" nodeType=""c"" id=""" & newpath & """ class=""kid"">"
         strNav = strNav &   "<img style=""filter:alpha(opacity=100);"" src=""" & icon &""" width=""18"" height=""18"" align=""absmiddle"">&nbsp;"
         strNav = strNav &   "<a title=""" & name & """ href=""loadtree.asp?path="& newPath & """ target=""explorer"">" & name & "</a>"
         strNav = strNav &   "<ul class=""hdn""></ul>"
         strNav = strNav & "</li>" & vbCrLf
  end if
