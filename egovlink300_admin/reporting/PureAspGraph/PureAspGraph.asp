...
Class PureAspGraph
	...
	Private iDataFormat				' FORMAT FOR DATA
   ...
   End Sub
	...
	Private Function printHorizontal()
		...
		response.write "<table border=0 style=""height:100%; background-color:#e0e0e0;border: solid 1px #000000;padding:5px;background-image: url(" & strPicPath & "images/gitterHorisontal_fade.gif);""  cellpadding=0 cellspacing=0 width=""400"">"
		response.write "<tr style=""height:1px;""><td><img alt="""" src=""" & strPicPath  & "images/blank.gif"" height=" & BAR_SPACING & "></td></tr>"
			For i=0 to ubound(arrItems)
				response.write "<tr>"
					response.write "<td align=""left"">"
						For g=0 to lngValueSetCount-1
							...
							If thisBarValue>=0 Then
								...
								response.write "<img alt="""" title=""" & GetDataFormat(arrValues(g, i),iDataFormat) & """ border=" & BAR_BORDER & " src=""" & strPicPath  & "images/blank.gif"" height=" & barWidth-2 & " width=" & thisBarValue & ">"
							Else
							...
							if showValue Then response.write "</td><td>&nbsp;" & GetDataFormat(arrValues(g, i),iDataFormat) & "</td></tr></table>"
						Next 
					response.write "</td>"
				response.write "</tr>" & vbNewLine
				if lngValueSetCount>1 AND  i<ubound(arrItems) Then
...
<%
	...
	Function GetDataFormat(sValue,iDataFormat)
