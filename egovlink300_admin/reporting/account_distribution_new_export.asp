...
Sub DisplaySummary( ByVal sWhereClause, ByVal sRptTitle )
	...
	sSql = sSql & " AND L.paymentid = P.paymentid AND L.amount <> 0.00 AND P.isforrentals = 0 AND P.journalentrytypeid < 5  " & sWhereClause 
...
'	response.write sSql & "<br />"
	...
	' Pull the Citizen Accounts - These are payments for classes only
	...
	sSql = sSql & " WHERE L.paymentid = P.paymentid AND L.paymenttypeid = 4 AND P.isforrentals = 0 AND P.journalentrytypeid = 1 AND A.accountid = OP.accountid AND "
...
'	response.write sSql & "<br />"
	...
	sSql = sSql & " WHERE L.paymentid = P.paymentid and L.paymenttypeid = 4 AND P.isforrentals = 0 AND P.journalentrytypeid = 1 AND "
	...
	' Total Row
	sTotalRow = "<tr><td></td><td></td><td></td><td>Totals</td>"
	sTotalRow = sTotalRow & "<td class=""moneystyle"">" & FormatNumber(dTotalCredit, 2) & "</td>"
	sTotalRow = sTotalRow & "<td class=""moneystyle"">" & FormatNumber(dTotalDebit, 2) & "</td>"
	sTotalRow = sTotalRow & "<td class=""moneystyle"">" & FormatNumber(dGrandTotal,2) & "</td></tr>"
...
Sub CreateDetailExcelDownload( ByVal sRtpTitle, ByVal sTotalRow )
	...
	If Not oSchema.EOF Then
		...
		response.write "<tr>"
		response.write "<th>Account Name</th><th>Account Number</th><th>Receipt No.</th><th>Date</th><th>Total Amt Credited</th><th>Total Amt Debited</th><th>Total Amt Transfered</th>"
