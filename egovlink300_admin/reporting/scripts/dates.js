function getDates( iSelection, iFieldID ) 
{
	...
	{
		if(iFieldID == "EndDates")
		{
			lcl_from_date = "fromEndDate";
			lcl_to_date   = "toEndDate";
		}
		else
		{
			lcl_from_date = "fromDate";
			lcl_to_date   = "toDate";
		}
	}
...
//			document.frmPFilter.toDate.value = tDate;
	...
	case '11':   
			// THIS WEEK
			var tempfromdt = new Date(d.getFullYear(),d.getMonth(),d.getDate()-d.getDay());
			var tempthrudt = new Date(d.getFullYear(),d.getMonth(),d.getDate()+ (6-d.getDay()));
...
//			document.frmPFilter.toDate.value = tDate;
	...
	case '12':   
			// LAST WEEK
			var tempfromdt = new Date(d.getFullYear(),d.getMonth(),d.getDate()-(d.getDay()+7));
			var tempthrudt = new Date(d.getFullYear(),d.getMonth(),d.getDate()+ (6-d.getDay()-7));
...
//			document.frmPFilter.toDate.value = tDate;
	...
	case '13':   
			// NEXT MONTH
			var tempfromdt=new Date(d.getFullYear(),d.getMonth()+1,1);
			var tempthrudt=new Date(d.getFullYear(),d.getMonth()+1,1);
