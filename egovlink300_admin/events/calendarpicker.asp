...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
  ...
  <table border="0" cellpadding="3" cellspacing="0" bgcolor="#ffffff" class="cal" width="100%" height="100%">
      ...
      <td bgcolor="#336699" align="center" colspan="7">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="15%" align="right" style="border:0px;" nowrap="nowrap"><a href="calendarpicker.asp?date=<%= AddOneMonth(dDate) %>&updatefield=<%=request("updatefield")%>&updateform=<%=request("updateform")%>"><font face="Arial" color="#ffffff" size="1"><%=langNextMonth%></font></a>&nbsp;<img src="../images/arrow_forward.gif" align="absmiddle" />&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    Do While iCurrent <= iDIM
	  ...
	  End If 
	  response.write ">"
	  response.write "<span style='width:100%; height:100%; cursor:pointer;' onclick=""doDateSelect('" & Month(dDate) & "/" & iCurrent & "/" & Year(dDate) & "');""><font size=2>" & iCurrent & "</font></span></td>" & vbCrLf
