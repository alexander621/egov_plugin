...
<body topmargin="0" leftmargin="0" bottommargin="0" rightmargin="0" marginwidth="0" marginheight="0">
  <form name="frmDate" action="qrtcalendarpicker.asp" method="get">
    ...
    <tr height="30">
      <td bgcolor="#336699" align="center" colspan="7">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" style="border:0px;" nowrap>&nbsp;<img src="images/arrow_back.gif" align="absmiddle">&nbsp;<A  href="javascript:void prevMonth();"><FONT face="Arial" COLOR=#ffffff SIZE="1"><u>Previous Month</u></FONT></A></td>
	      ...
	      <% For x =1900 to 3000
            ...
            <td width="15%" align="right" style="border:0px;" nowrap><A href="javascript:void nextMonth();"><FONT face="Arial" COLOR=#ffffff SIZE="1"><u>Next Month</u></FONT></A>&nbsp;<img src="images/arrow_forward.gif" align="absmiddle">&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
