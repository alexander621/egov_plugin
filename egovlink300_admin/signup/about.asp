        ...
        <table border="0" cellpadding="10" cellspacing="0" width="100%" height="100%">
          <tr>
                ...
                <tr>
                  <td valign="top" height="100%" style="padding:5px;">
                    <table border="0" cellpadding="2" cellspacing="0">
                      ...
                      <tr>
                        <td><img src="../images/square_bullet.gif" align="absmiddle">&nbsp;<a href="about.asp"><b>About <%=Application("ProgramName")%></b></a></td>
                      </tr>
                      <tr>
            ...
            <td valign="top" style="font-family:Tahoma,Arial,Verdana;">
              <font size="3" color="#0000bb"><b>About <%=Application("ProgramName")%></b></font><br>
             <br>
