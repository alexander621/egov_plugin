...
<body>
  ...
  <!--Begin Page Header -->
	...
	<!--Begin Search Form -->
	<form action="search2.asp" method="post" name="frmSearch">
		<table cellpadding="0" cellspacing="0" border="0" id="searchbox">
			<tr>
				<td nowrap="nowrap">
					<strong>Search:</strong>  
					<input type="hidden" name="Action" value="Go" />
					<input type="text" id="SearchString" name="SearchString" size="65" maxlength="100" style="background-color:#eeeeee;width:255px; height:19px; border:1px solid #000033;" value="<%= SearchString %>" />
...
If NewQuery Then
    ...
    If FormScope <> "/" Then
		...
		Else
			...
			response.write "sSearchFolderPath = " & sSearchFolderPath & "<br /><br />"
			util.AddScopeToQuery Q, sSearchFolderPath, "deep"
		End If 
'	Else
  ...
  End If
	...
	If session("blnSeparateIndex") Then
		...
		response.write "Seperate Index <br /><br />"
...
<%
	...
	If CurrentPage > 1 And RS.RecordCount <> -1 Then  
%>
		<form name="frmPrev" action="search2.asp" method="get" />
...
<%		
	...
	If Not RS.EOF Then   
%>
		<form name="frmNext" action="search2.asp" method="get" />
			<input type="hidden" name="qu" value="<%=SearchString%>" />
			<input type="hidden" name="FreeText" value="<%=FreeText%>" />
			<input type="hidden" name="sc" value="<%=FormScope%>" />
			<input type="hidden" name="RankBase" value="<%=RankBase%>" />
