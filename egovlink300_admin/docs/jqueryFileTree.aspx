...
/// </summary>
	...
	{
		if ( dir + di_child.Name != OrgUrl + "attachments" && dir + di_child.Name != OrgUrl + "pdf_forms" && dir + di_child.Name != OrgUrl + "postings_bids" && dir + di_child.Name != OrgUrl + "mobile_uploads" )
		{
			FolderClass = "";
