...
If Request.Form("_task") = "newpoll" Then
  ...
  With oCmd
    ...
    .Execute
  End With
  Response.Redirect "../../meetings/pollSelect/listPolls.asp"
End If
...
<head>
  ...
  <!--
    function doMembers() {
      ...
      win = window.open("../../polls/members_buffered.asp?mem="+mem, "members", "width=450,height=350,status=0,menubar=0,scrollbars=0,toolbar=0,left="+x+",top="+y+",z-lock=yes");
      win.focus();
    }
  //-->
  </script>
    ...
    <tr>
      ...
      <td colspan="2" valign="top">
        <form name="frmNewPoll" method=post action="newpoll.asp" method="post">
          ...
          <div style="font-size:10px; padding-bottom:5px;"><img src="../../images/cancel.gif" align="absmiddle">&nbsp;<a href="../../pollSelect"><%=langCancel%></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../images/go.gif" align="absmiddle">&nbsp;<a href="javascript:document.all.frmNewPoll.submit();"><%=langCreate%></a></div>
          ...
          <div style="font-size:10px; padding-top:5px;"><img src="../../images/cancel.gif" align="absmiddle">&nbsp;<a href="../../pollSelect"><%=langCancel%></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../images/go.gif" align="absmiddle">&nbsp;<a href="javascript:document.all.frmNewPoll.submit();"><%=langCreate%></a></div>
          <br>
          <br>
          <br>
