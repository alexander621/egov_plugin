...
If Not oRst.EOF Then
  ...
  Do While Not oRst.EOF
    ...
    sMsgs = sMsgs & "<td nowrap>" & oRst("To") & "</td>"
    sMsgs = sMsgs & "<td>" & oRst("Subject") & "&nbsp;&nbsp;<a href=""compose.asp?pid=" & oRst("PmailID") & """><img src=""../images/edit.gif"" align=""absmiddle"" border=0></a></td>"
  ...
  oRst.Close
Else
  sMsgs = "<tr><td colspan=6 style=""border:0px;"">" & langNoDrafts & "</td></tr>"
End If
...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
  ...
  <table border="0" cellpadding="10" cellspacing="0" class="start" width="100%">
    <tr>
      ...
      <td><font size="+1"><b><%=langMessages%>: <%=langDrafts%></b></font><br><%=langYouHave%>&nbsp;<%= iTotal %>&nbsp;<%=langDrafts%>.</td>
    </tr>
    <tr>
      <td valign="top">
        ...
        <div class="quicklink">&nbsp;&nbsp;<img src="../images/folder_opened.gif" width="16" height="16" align="absmiddle">&nbsp;<a href="drafts.asp"><i><%=langDrafts%></i></a></div>
      ...
      <td valign="top">
        <form name="frmMsgList" action="delete.asp" method="post">
          ...
          <input type="hidden" name="BackPage" value="drafts.asp">
          
          <div style="font-size:10px; padding-bottom:5px;"><img src="../images/arrow_back.gif" align="absmiddle">
          
          <%
          If iPage > 1 Then
            Response.Write "<a href=""drafts.asp?page=" & iPage-1 & """>" & langPrev & "  " & Session("PageSize") & "</a>&nbsp;&nbsp;"
          Else
            Response.Write "<font color=""#999999"">Prev " & Session("PageSize") & "</font>&nbsp;&nbsp;"
          End If

          If iNumMoreRecords > 0 Then
            Response.Write "<a href=""drafts.asp?page=" & iPage+1 & """>" & langNext & " " & Session("PageSize") & "</a>"
          Else
