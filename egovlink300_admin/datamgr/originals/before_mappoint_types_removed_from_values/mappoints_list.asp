...
'Check for org features
 lcl_orghasfeature_feature          = orghasfeature("mappoints_maint")
 lcl_orghasfeature_feature_maintain = orghasfeature("mappoints_maint")

'Check for user permissions
 lcl_userhaspermission_feature          = userhaspermission(session("userid"),"mappoints_maint")
 lcl_userhaspermission_feature_maintain = userhaspermission(session("userid"),"mappoints_maint")
  ...
  <tr>
      <td valign="top">
          <div style="margin-top:20px; margin-left:20px;">
                          ...
                          <tr>
                              <td>
                                  ...
                                  <select name="sc_mappoint_typeid" id="sc_mappoint_typeid">
                                    <option value=""></option>
                                    <% displayMapPointTypes session("orgid"), lcl_sc_mappoint_typeid %>
                                  </select>
                              </td>
                          </tr>
                        </table>
            ...
            <p><input type="button" name="addButton" id="addButton" value="Add Map-Point" class="button" onclick="location.href='mappoints_maint.asp<%=lcl_url_parameters%>'" /></p>
            <% displayMapPoints session("orgid"), lcl_sc_mappoint_typeid, lcl_url_parameters %>
            </p>
          </div>
      </td>
  </tr>
...
<%
'------------------------------------------------------------------------------
sub displayMapPoints(p_orgid, p_sc_mappoint_typeid, p_url_parameters)
 	Dim iRowCount
...
'  sSQL = sSQL & " ORDER BY " & lcl_orderby
     ...
     response.write "      <th align=""left"" width=""200"">Property Address</th>" & vbcrlf
