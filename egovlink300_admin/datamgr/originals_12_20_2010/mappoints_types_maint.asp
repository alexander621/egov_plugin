...
function addFieldRow() {
  ...
  var f = mytbl.insertCell(5);  //In Public Search"
  var g = mytbl.insertCell(6);  //Include "Add a Link"
  var h = mytbl.insertCell(7);  //Display as Multi-Line
  var i = mytbl.insertCell(8);  //Delete Row and Additional Info
  ...
  //Display On Info Page
  f.align     = "center";
  f.innerHTML = '<input type="checkbox" name="inPublicSearch' + totalrows + '" id="inPublicSearch' + totalrows + '" value="1" />';

  //Include "Add a Link"
  g.align     = "center";
  g.innerHTML = '<input type="checkbox" name="hasAddLinkButton' + totalrows + '" id="hasAddLinkButton' + totalrows + '" value="1" />';

  //Include "Add a Link"
  h.align     = "center";
  h.innerHTML = '<input type="checkbox" name="isMultiLine' + totalrows + '" id="isMultiLine' + totalrows + '" value="1" />';
...
<%
  ...
  response.write "  </tr>" & vbcrlf
  response.write "  <tr>" & vbcrlf
  response.write "      <td nowrap=""nowrap"">Display Map on public page:</td>" & vbcrlf
  response.write "      <td><input type=""checkbox"" name=""displayMap"" id=""displayMap"" value=""Y""" & lcl_checked_displayMap & "/></td>" & vbcrlf
  response.write "  </tr>" & vbcrlf
  response.write "  <tr>" & vbcrlf
  response.write "      <td nowrap=""nowrap"">Use Advanced Search (public-side enabled):</td>" & vbcrlf
  response.write "      <td><input type=""checkbox"" name=""useAdvancedSearch"" id=""useAdvancedSearch"" value=""Y""" & lcl_checked_useAdvancedSearch & "/></td>" & vbcrlf
  response.write "  </tr>" & vbcrlf
