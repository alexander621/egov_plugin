  ...
  <table border="0" cellpadding="10" cellspacing="0" class="start" width="100%">
	...
	<tr>
	  ...
	  <!--BEGIN: ACTION LINE REQUEST LIST -->
		...
		sSQL = "Select paymentdate as [Payment Date],userlname + ', ' + userfname as Account,classname as [Item Description],paymenttypename as [Payment Type],paymentlocationname as [Payment Location],isnull(amount,0) as Credit,Cast(0 as Money) as Debit,paymentreferenceid as [Transaction ID],(" & sSQLSUM  & ") as [Grand Total] from egov_class_to_user_payment_report " & varWhereClause
