...
<div id="content">
	<div id="centercontent">
		<p>
			Ongoing Activity Name: <input type="text" name="classname" value="Karate" size="50" maxlength="50" />
			&nbsp; <strong>This is a Ongoing Activity Parent</strong>
		</p>
		<p>
			Status: <strong>Active</strong>  &nbsp; &nbsp; 
			<!--<input type="button" class="button" name="cancel" value="Cancel Class/Event" />
		...
		<p>
			Description:<br /><textarea name="classdescription" id="classdescription">Bi-weekly lessons in this martial art.</textarea>
		</p>
		<p>
			Search Keywords:<br />
			<input type="text" name="searchkeywords" value="fitness karate" size="100" maxlength="1000" />
		</p>
		<p>
			Restrictions:<br /> 
		...
		<p>
			External URL: <input type="text" name="externalurl" value="http://www.karateclassrus.com" size="50" maxlength="255" />
		</p>
		</fieldset>
		...
		<p>
			Days of the Week: 
				...
				<input type="checkbox" name="dayofweek" value="2" checked="checked" /> Monday
				<input type="checkbox" name="dayofweek" value="3" /> Tuesday
				<input type="checkbox" name="dayofweek" value="4" checked="checked" /> Wednesday
		...
		<p>
				<table id="ongoingtime" border="0" cellpadding="0" cellspacing="0">
		...
		<p>
			...
			<input type="button" class="button" name="copy" value="Copy to New Ongoing Class/Event" />
			
		<p>

		<fieldset class="edit"><legend><strong> Child Classes/Events </strong></legend>
		<p>
			<input type="button" class="button" name="child" value="Create New Child" id="newchild" /><br />
			<table id="children" border="1" cellpadding="0" cellspacing="0">
				<tr><th>Class/Event Name</th><th>Starts</th><th>Ends</th><th>&nbsp;</th></tr>
				<tr class="alt_row"><td>Karate - May</td><td>5/1/2006</td><td>5/31/2006</td><td><input type="button" class="button" name="editchild" value="Edit" /></td></tr>
				<tr><td>Katate - June</td><td>6/1/2006</td><td>6/30/2006</td><td><input type="button" class="button" name="editchild" value="Edit" /></td></tr>
			</table>
		</p>
		</fieldset>
