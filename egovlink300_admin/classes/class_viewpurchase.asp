...
' 1.0   03/29/06	Steve Loar - Initial Version
...
<div id="content">
	<div id="centercontent">
		<div id="receiptlinks">
			<a href="roster_list.asp"><img src="../images/arrow_2back.gif" align="absmiddle" border="0">&nbsp;Purchase another Class/Event</a><br /><br />
		</div>
		<div id="topprintbutton">
			<input type="button" class="button" onclick="javascript:window.print();" value="Print" />
		</div>

		<h3><%=Session("sOrgName")%> Registration Receipt</h3> 
		<br /><br />
...
<%
	...
	If GetPaymentDetails( iPaymentId, iUserId, nTotal, dPaymentDate ) Then 
		...
		oDetails.Open sSQL, Application("DSN"), 0, 1
		...
		Do While Not oDetails.EOF
			...
			If oDetails("startdate") <> "" Then 
				response.write " &nbsp;  &nbsp; &nbsp; &nbsp;" & MonthName(Month(oDetails("startdate"))) & " " & Day(oDetails("startdate"))
			End If 
			' handle enddate
			bMultiWeeks = false
			If oDetails("enddate") <> "" And oDetails("enddate") <> oDetails("startdate") Then 
				response.write " &ndash; " & MonthName(Month(oDetails("enddate"))) & " " & Day(oDetails("enddate"))
			...
			' DISPLAY WAIVER LINK
			ListWaivers SESSION("ORGID"),oDetails("classid"),0,0,1
...
Function ShowUserInfo( iUserId )
	...
	ShowUserInfo = "<table border=""0"" cellpadding=""0"" cellspacing=""5"" id=""receiptuserinfo"">"
	ShowUserInfo = ShowUserInfo & "<tr><td align=""right"" valign=""top"">Name:</td><td >" & oUser("userfname") & " " & oUser("userlname") & "&nbsp;&nbsp;&nbsp;<strong>" & sResidentDesc & "</strong></td></tr>"
	ShowUserInfo = ShowUserInfo & "<tr><td align=""right"" valign=""top"">Email:</td><td>" & oUser("useremail") & "</td></tr>"
	ShowUserInfo = ShowUserInfo & "<tr><td align=""right"" valign=""top"">Phone:</td><td>" & FormatPhone(oUser("userhomephone")) & "</td></tr>"
	ShowUserInfo = ShowUserInfo & "<tr><td align=""right"" valign=""top"">Address:</td><td>" & oUser("useraddress") & "<br />" 
	If oUser("useraddress2") = "" Then 
		ShowUserInfo = ShowUserInfo & oUser("useraddress2") & "<br />" 
	End If 
	ShowUserInfo = ShowUserInfo & oUser("usercity") & ", " & oUser("userstate") & " " & oUser("userzip") & "</td></tr>"
