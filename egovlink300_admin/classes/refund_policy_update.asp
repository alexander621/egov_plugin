...
'
'--------------------------------------------------------------------------------------------------
' FILENAME: refund_policy_update.asp
' AUTHOR: Steve Loar
' CREATED: 7/11/2007
' COPYRIGHT: Copyright 2007 eclink, inc.
'			 All Rights Reserved.
'
' Description:  This creates or updates the refund policy, goes with refund_policy_edit.asp
'
...
sMessage = DBsafe(request("refundpolicy"))
