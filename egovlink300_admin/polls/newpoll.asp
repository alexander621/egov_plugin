...
If Request.Form("_task") = "newpoll" Then
  ...
  With oCmd
    ...
    .Parameters.Append .CreateParameter("@VoteType", adInteger, adParamInput, 4, iVoteType)
    .Parameters.Append .CreateParameter("@Subject", adVarChar, adParamInput, 30, sTopic)
    .Parameters.Append .CreateParameter("@Question", adVarChar, adParamInput, 250, sQuestion)
    .Parameters.Append .CreateParameter("@Description", adVarChar, adParamInput, 1000, sDesc)
    .Parameters.Append .CreateParameter("@GroupIDs", adVarChar, adParamInput, 1000, sMembers)
