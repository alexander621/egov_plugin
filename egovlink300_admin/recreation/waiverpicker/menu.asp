...
<body bgcolor="#666666" topmargin="0" leftmargin="0">
  <table border="0" cellpadding="0" cellspacing="0" width="85">
    <tr><td align="center"><div class="sel" id="exdoc" onclick="MakeActive(this);parent.explorer.window.location.href='loadtree.asp?path=<%="/public_documents300/custom/pub/" & sLocationName & "/published_documents" %>';" ><img src="images/existdoc.gif"><br>Documents</div></td>
    </tr>
