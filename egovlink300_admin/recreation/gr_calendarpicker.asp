...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
  <form name="frmDate" action="gr_calendarpicker.asp" method="post">
  ...
  <table border="0" cellpadding="3" cellspacing="0" bgcolor="#ffffff" class="cal" width="100%" height="100%">
    <tr height="30">
      <td bgcolor="#336699" align="center" colspan="7">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" style="border:0px;" nowrap>&nbsp;<img src="../images/arrow_back.gif" align="absmiddle" />&nbsp;<a href="gr_calendarpicker.asp?date=<%= SubtractOneMonth(dDate) %>&updatefield=<%=request("updatefield")%>&updateform=<%=request("updateform")%>"><font face="Arial" color="#ffffff" size="1"><%=langPreviousMonth%>h</font></a></td>
            ...
            <td width="15%" align="right" style="border:0px;" nowrap><a href="gr_calendarpicker.asp?date=<%= AddOneMonth(dDate) %>&updatefield=<%=request("updatefield")%>&updateform=<%=request("updateform")%>"><font face="Arial" color="#ffffff" size="1"><%=langNextMonth%></font></a>&nbsp;<img src="../images/arrow_forward.gif" align="absmiddle">&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    Do While iCurrent <= iDIM
      ...
      'Response.Write vbTab & vbTab & "<td><span class=""pickerday"" style='width:100%; height:100%; cursor:hand;' onclick=""javascript:doDateSelect('" & Month(dDate) & "/" & iCurrent & "/" & Year(dDate) & "');""><font size=2>" & iCurrent & "</font></span></td>" & vbCrLf
