...
Sub DrawCalendar()
    ...
    ' DIVIDER
    Response.Write("<hr align=""left"" width=""760"" size=""1"" color=""#000"" />" & vbcrlf)
...
Sub DrawLegend()
	...
	'response.write "<div style=""background-color:#919191;width:200px;margin-bottom:20px;"">" & vbcrlf
	response.write "<table class=""calendarlegend"" cellspacing=""2"">" & vbcrlf
	...
	response.write "<tr><td class=""callegendholiday"">&nbsp;</td><td class=""legendlabel"">Holiday</td></tr>" & vbcrlf
	response.write "</table>" & vbcrlf
