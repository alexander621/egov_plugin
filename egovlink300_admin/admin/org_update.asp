...
sPrivacyPolicyEgov   = "NULL"
sPrivacyPolicyMobile = "NULL"

sPrivacyPolicyURLEgov  = request("privacypolicy_url_egov")
sPrivacyPolicyTextEgov = request("privacypolicy_text_egov")

sPrivacyPolicyURLMobile  = request("privacypolicy_url_mobile")
sPrivacyPolicyTextMobile = request("privacypolicy_text_mobile")

sPrivacyPolicyEgov = "["
sPrivacyPolicyEgov = sPrivacyPolicyEgov & sPrivacyPolicyURLEgov
sPrivacyPolicyEgov = sPrivacyPolicyEgov & "]<"
sPrivacyPolicyEgov = sPrivacyPolicyEgov & sPrivacyPolicyTextEgov
sPrivacyPolicyEgov = sPrivacyPolicyEgov & ">"

sPrivacyPolicyMobile = "["
sPrivacyPolicyMobile = sPrivacyPolicyMobile & sPrivacyPolicyURLMobile
sPrivacyPolicyMobile = sPrivacyPolicyMobile & "]<"
sPrivacyPolicyMobile = sPrivacyPolicyMobile & sPrivacyPolicyTextMobile
sPrivacyPolicyMobile = sPrivacyPolicyMobile & ">"

sPrivacyPolicyEgov   = "'" & dbsafe(sPrivacyPolicyEgov)   & "'"
sPrivacyPolicyMobile = "'" & dbsafe(sPrivacyPolicyMobile) & "'"
...
If CLng(iOrgId) > CLng(0) Then 
	...
	sSql = sSql & " privacypolicy_egov = "	  		         & sPrivacyPolicyEgov   				        & ", "
	sSql = sSql & " privacypolicy_mobile = "	  		       & sPrivacyPolicyMobile 				        & ", "
...
Else
 ...
 sSql = sSql & " privacypolicy_mobile, "
	...
	sSql = sSql &       sPrivacyPolicyEgov   			         & ", "
	sSql = sSql &       sPrivacyPolicyMobile 			         & ", "
	...
	sSql = "Insert Into users ( orgid, username, epassword, lastname, firstname, isrootadmin, pagesize ) Values ( " & iOrgId & ", 'eclink', '0BB07F5104B2814D8743526AF85B3EEF3A849991A1B6F5C17279ABEB6940F153cb1777b88d2e75564787fde7aa9d0e9d0e586dcd743f82924dcf0dcb65e04faf', 'ECLink', 'Admin', 1, 20)"
	...
	sSql = "INSERT INTO egov_verisign_options ( vendor, [user], password, partner, IsLive, liveurl, orgid, feature ) VALUES ( '" & sOrgVirtualSiteName1 & "', '" & sOrgVirtualSiteName1 & "', '" & sOrgVirtualSiteName1 & "', 'paypal', 1, 'payflow.verisign.com', " & iOrgId & ", 'default' )"
	RunSQL sSql
