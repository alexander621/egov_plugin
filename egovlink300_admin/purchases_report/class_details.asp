...
<html>
<head>
	<title>E-Gov Recreation Activity Purchase Details</title>
...
<script defer>
	function window.onload() {
	  factory.printing.header = "Recreation Activity Purchase - Printed on &d"
	  factory.printing.footer = "&bRecreation Activity Purchase - Printed on &d - Page:&p/&P"
...
<div id="content">
	<div id="centercontent">
		...
		<div id="receiptlinks">
			...
			<!--<span id="printbutton"><input type="button" class="button" onclick="javascript:window.print();" value="Print" /></span>-->
		</div>
		

		<h3><%=Session("sOrgName")%> Recreation Activity Purchase</h3> 
...
'		response.write vbcrlf & "</div>"
		...
		If Not oDetails.EOF Then 
			...
			Do While Not oDetails.EOF 
				...
				End If 
				If CLng(oDetails("familymemberid")) <> CLng(0) Then 
