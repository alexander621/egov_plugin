...
<head>
  ...
  <!--
	...
	function buildlink(sFormField){
	  ...
	  if (path =='') {
		sLink = "<a target='_EGOVLINK' href='http://www.egovlink.com" + sVirtualDir + "/docs/menu/home.asp?path=" + sFolderPath + "'>" + sLinkName + "</a>";
		sLink = sLink.replace("/custom/pub","");
		sUrlOnly = "http://www.egovlink.com" + sVirtualDir + "/docs/menu/home.asp?path=" + sFolderPath;
		sUrlOnly = sUrlOnly.replace("/custom/pub","");
	  }
	  else
	  {
		sLink = "<a target='_EGOVLINK' href='http://www.egovlink.com" + document.all.currentpath.value + "/" + path + "'>" + sLinkName + "</a>";
		sLink = sLink.replace("/custom/pub","");
		sUrlOnly = "http://www.egovlink.com" + document.all.currentpath.value + "/" + path;
		sUrlOnly = sUrlOnly.replace("/custom/pub","");
	  }
	...
	function buildactionlink(sFormField){
	  ...
	  sUrlOnly = "http://www.egovlink.com/" + sLocation + "/action.asp?actionid=" + iFormID;
	...
	function buildpaymentlink(sFormField){
	  ...
	  sUrlOnly = "http://www.egovlink.com/" + sLocation + "/payment.asp?paymenttype=" + iFormID;
  ...
  <table border="0" cellpadding="3" cellspacing="0">
    ...
    <tr>
      <td valign="top">
        ...
        <iframe id="explorer" name="explorer" width="400" height="250" src="loadtree.asp?path=<%="/public_documents300/custom/pub/" & sLocationName & "/published_documents" %>"></iframe>
