...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
  ...
  <table border="0" cellpadding="10" cellspacing="0" class="start" width="100%">
    <tr>
	    <td><font size="+1"><b>(E-Gov Payment Receipt Manager) - Manage Online Submitted Payments</b></font><br><img src="../images/arrow_2back.gif" align="absmiddle">&nbsp;<a href="javascript:history.back()"><%=langBackToStart%></a></td>
    </tr>
	<tr>
    <td>
...
if oRequests.EOF then
   ...
   If subTotals <> "yes" Then 
  	    ...
  	    Response.write "<div><table width=""100%""><tr><td valign=top><table><tr><td><a href=""action_line_list.asp?pagenum="&abspage - 1&"&"&sQueryString&"""><img border=0 src=""../images/arrow_back.gif""></a></td><td valign=top><a href=""action_line_list.asp?pagenum="&abspage - 1&"&"&sQueryString&""">BACK</a></td><td valign=top>&nbsp;"  & "<a href=""action_line_list.asp?pagenum="&abspage + 1&"&"&sQueryString&""">NEXT</a></td><td valign=top><a href=""action_line_list.asp?pagenum="&abspage + 1&"&"&sQueryString&"""><img border=0 src=""../images/arrow_forward.gif"" valign=bottom></a></td><td>&nbsp;&nbsp;</td><td><img src=../images/icon_checkmark.png border=0><a href=""javascript:document.all.FormProcess.submit();"" onClick=""javascript: return confirm('Performing this action will change status of the selected items to Processed. Are you sure you want to proceed?');"">Process</a></td></tr></table></td><td width=450 align=right><!--<a href=""action_line_list_print.asp?orderBy=" & orderBy & "&statusInProgress=" & statusInProgress & "&statusPending=" & statusPending & "&statusRefund=" & statusRefund & "&statusDenied=" & statusDenied & "&statusCompleted=" & statusCompleted & "&statusProcessed=" & statusProcessed & "&toDate=" & toDate & "&fromDate=" & fromDate & "&showDetail=" & showDetail & "&subTotals=" & subTotals & """ target=new>Open New Printer Friendly Results Window</a>-->    "
  ...
  Else
			' DISPLAY TOTAL RECORDS	
				Response.write "<div><table width=""100%""><tr><td valign=top><table><tr><td><b><font color=blue>" & oRequests.RecordCount & "</font> total Online Payments</b></td><td>&nbsp;&nbsp;&nbsp;<img src=../images/icon_checkmark.png border=0><a href=""javascript:document.all.FormProcess.submit();"" onClick=""javascript: return confirm('Performing this action will change status of the selected items to Processed. Are you sure you want to proceed?');"">Process</a></td></tr></table></td><td width=450 align=right><!--<a href=""action_line_list_print.asp?orderBy=" & orderBy & "&statusRefund=" & statusRefund & "&statusInProgress=" & statusInProgress & "&statusProcessed=" & statusProcessed & "&statusPending=" & statusPending & "&statusCompleted=" & statusCompleted & "&statusDenied=" & statusDenied & "&fromDate=" & fromDate & "&toDate=" & toDate & "&showDetail=" & showDetail & "&subTotals=" & subTotals & """ target=new>Open New Printer Friendly Results Window</a>-->"
		...
		curGrandTotal = oRequests("GRANDTOTAL")
			  ...
			  ' GET VALUES
				...
				If oRequests("paymentdate") <> "" Then
					datSubmitDate = LocalDateTime(oRequests("paymentdate"))
...
'------------------------------------------------------------------------------------------------------------
' Function LocalDateTime(datDateTime)
'------------------------------------------------------------------------------------------------------------
Function LocalDateTime(datDateTime)
	' TIMEZONE DIFFERENCE
	datGMTDateTime = DateAdd("h",5,datDateTime)
	datOrgDateTime = DateAdd("h",session("iTimeOffset"),datGMTDateTime)
	
	' RETURN DATE
	LocalDateTime = datOrgDateTime
