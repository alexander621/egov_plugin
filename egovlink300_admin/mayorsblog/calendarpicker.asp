...
<head>
  ...
  <!--
    function doDateSelect(d, ToFrom) {
     
      if(ToFrom != "From" && ToFrom != "To") {
         window.opener.document.getElementById(ToFrom).value = d;
      }else{
         if(ToFrom=="From") {
           	window.opener.document.all.fromDate.value = d;
         }else{
           	window.opener.document.all.toDate.value = d;
         }
      }
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
  ...
  <input type="hidden" name="ToFrom" value="<%=Request("ToFrom")%>">
  ...
  <table border="0" cellpadding="3" cellspacing="0" bgcolor="#ffffff" class="cal" width="100%" height="100%">
    <tr height="30">
      <td bgcolor="#336699" align="center" colspan="7">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" style="border:0px;" nowrap>&nbsp;<img src="../images/arrow_back.gif" align="absmiddle">&nbsp;<A HREF="calendarpicker.asp?ToFrom=<%=Request("ToFrom")%>&date=<%= SubtractOneMonth(dDate) %>"><FONT face="Arial" COLOR=#ffffff SIZE="1"><%=langPreviousMonth%></FONT></A></td>
            ...
            <td width="15%" align="right" style="border:0px;" nowrap><A HREF="calendarpicker.asp?ToFrom=<%=Request("ToFrom")%>&date=<%= AddOneMonth(dDate) %>"><FONT face="Arial" COLOR=#ffffff SIZE="1"><%=langNextMonth%></FONT></A>&nbsp;<img src="../images/arrow_forward.gif" align="absmiddle">&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    Do While iCurrent <= iDIM
      ...
      Response.Write vbTab & vbTab & "<td><span style='width:100%; height:100%; cursor:hand;' onclick=""javascript:doDateSelect('" & Month(dDate) & "/" & iCurrent & "/" & Year(dDate) & "','" & Request("ToFrom") & "');""><font size=2>" & iCurrent & "</font></span></td>" & vbCrLf
