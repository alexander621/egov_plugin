...
strSQL1 = "select  name from subscribe"
strSQL2 = "select s.name from sysobjects s  where xtype='U' and s.name not in( select name from subscribe)"
...
response.write "<TR><TD>"
 response.write "<form name=c1 method='POST' action='subscribe_delete.asp'>"
...
response.write "<TR><TD>"
 response.write "<form name=r1 method='POST' action='subscribe_Add.asp'>"
