...
Call subFamilyUpdate(request("iuserid"), request("familymemberid"), request("firstname"), request("lastname"), request("relation"), request("birthdate"))
...
Sub subFamilyUpdate(iuserid, familymemberid, firstname, lastname, relation, birthdate)
	...
	If CLng(familymemberid) = CLng(0) Then 
	' Insert new records
