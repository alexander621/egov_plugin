...
if lcl_sc_from_date = "" OR isnull(lcl_sc_from_date) then
   lcl_sc_from_date = dateserial(Year(Now()),1,1)
end if
...
<head>
	...
	<!--
		...
		function validate()
		{
			...
			if ($("frompurchasedate").value != '')
			{
				if (! isValidDate($("frompurchasedate").value))
				{
			...
			if ($("topurchasedate").value != '')
			{
				if (! isValidDate($("topurchasedate").value))
				{
			...
			if ($("fromstartdate").value != '')
			{
				if (! isValidDate($("fromstartdate").value))
				{
					alert("The Start 'From' Date should be a valid date in the format of MM/DD/YYYY.  \nPlease enter it again.");
					$("fromstartdate").focus();
					return;
				}
				if ($("tostartdate").value == '')
				{
			...
			if ($("tostartdate").value != '')
			{
				if (! isValidDate($("tostartdate").value))
				{
  ...
  <table border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="javascript:void doCalendar('sc_from_date');"><img src="../images/calendar.gif" border="0"></a>
        </td>
		<td>To: </td>
        <td>
            <input type="text" id="topurchasedate" name="topurchasedate" value="<%=lcl_sc_to_date%>" size="15" maxlength="10">&nbsp;
            <a href="javascript:void doCalendar('sc_to_date');"><img src="../images/calendar.gif" border="0"></a>
			&nbsp;
	...
	<tr>
        ...
        <td>
            ...
            <a href="javascript:void doCalendar('sc_from_startdate');"><img src="../images/calendar.gif" border="0"></a>
        </td>
		<td>To: </td>
        <td>
            <input type="text" id="tostartdate" name="tostartdate" value="<%=lcl_sc_to_startdate%>" size="15" maxlength="10">&nbsp;
            <a href="javascript:void doCalendar('sc_to_startdate');"><img src="../images/calendar.gif" border="0"></a>
			&nbsp;
    ...
    <tr>
        <td colspan="5">
            <input type="button" class="button" value="Search" onclick="validate();">
        </td>
    </tr>
    </form>
  </table>
...
<%
	...
	sSql = sSql & " AND (P.paymentdate >= '" & lcl_sc_from_date & " 23:59:59' AND P.paymentdate <= '" & lcl_sc_to_date & " 00:00:00') "

	If lcl_sc_from_startdate <> "" Then
		sSql = sSql & " AND (C.startdate >= '" & lcl_sc_from_startdate & " 23:59:59' AND C.startdate <= '" & lcl_sc_to_startdate & " 00:00:00') "
	End If 

	'Setup the ORDER BY
	If lcl_sc_orderby = "PURCHASE_DATE" Then 
		sSql = sSql & " ORDER BY P.paymentdate DESC"
	Else 
