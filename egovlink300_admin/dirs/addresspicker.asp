	...
	<head>
		...
		<!--
			...
			function doSelect()
			{
				...
				window.opener.document.register.egov_users_residenttype.value = 'R';
			...
			function doKeep()
			{
				...
				window.opener.document.register.egov_users_residenttype.value = 'N';
				<% if request("sCheckType") = "FinalCheck" then %>
					window.opener.checkDuplicateCitizens( 'FinalUserCheckFailed' );
				<% elseif request("sCheckType") = "FinalCheckValidate" then %>
					window.opener.finalCheckValidate();
...
<!--			<p class="addresspicker">
				<strong>If you were saving a registration when you got this window, you will need to resubmit the form.</strong>
			<p>
-->
		</form>
	</div>
