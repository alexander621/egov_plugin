...
dim conTABLEFIELDS()
dim l_fields()
	conTABLENAME="UsersExtended"
TableDescription=array( _ 
"ID int PRIMARY KEY","userID int not null","property [varchar](25)", _
"value [varchar](100)","joindate datetime")  
fields_description=fields_description_extended
