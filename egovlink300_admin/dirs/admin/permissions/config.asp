...
const cPageSize =30
const IDCol=0
conTABLENAME="permissions"
sConnForum =Application("DSN")
l_register=array(0,1,1)
l_display=array(1,1,1)
l_modify=array(0,1,1)
const langAdminTitle	= "Manage the Permissions"
'const langAdminCloseWindow	= "Close Window"
Const langNewRecord		= "New Permission"
Const langRecordList	= "Permission List"
Const langSubmitNewRecord = "Submit a new permission"
Const langUpdateRecord = "Update the permission"
'Const langGoBack			= "Go Back"
'Const langDelete			= "Delete"
const langResponseAfterPostSave="Successfully add a new permission"
