...
<TR><TD align=center><font size="+1">Manage  <b> <%=CommitteeName%> </b></font><br></TD></TR>
<TR><TD>
<%
thisname=request.servervariables("script_name")
set conn = Server.CreateObject("ADODB.Connection")
...
response.write "<TD>"
response.write "Existing Members"
...
response.write "</td><TD>"
response.write "Remaining Members"
...
sub CommitteeMemberList
   response.write "<form name=c1 method='POST' action='deletemember.asp?groupid="&trim(request.querystring("groupid"))&"'>"
...
sub  TheRemainingMemberList
   response.write "<form name=r1 method='POST' action='AddMember.asp?groupid="&trim(request.querystring("groupid"))&"'>"
