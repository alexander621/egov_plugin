...
response.write "<table border=0 cellpadding=5 class='tablelist' cellspacing=1 align=center width="&constTableWidth&" bgcolor='" & cForumBgColor & "'>"
response.write "<tr>"
...
response.write "<tr>"& _
  ...
  Next
response.write  "<td><A HREF=javascript:openWin2('ManageMember.asp?groupid="&RA(0,i)&"','_blank')><I><FONT SIZE=1>Add</FONT></I></A></td>"
response.write " </tr>"
next     
