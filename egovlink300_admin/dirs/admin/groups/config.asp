...
l_register=array(0,1,1,1,0)
l_display=array(1,1,1,1,1)
l_modify=array(0,1,1,1,0)
const langAdminTitle	= "Manage Group"
'const langAdminCloseWindow	= "Close Window"
Const langNewRecord		= "New Group"
Const langRecordList	= "Group List"
Const langSubmitNewRecord = "Submit New Group"
Const langUpdateRecord = "Update the Group"
'Const langGoBack			= "Go Back"
'Const langDelete			= "Delete"
const langResponseAfterPostSave="Successfully add a new Group"
