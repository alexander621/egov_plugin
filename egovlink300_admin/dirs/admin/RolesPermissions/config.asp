...
const cPageSize =10
const IDCol=0
const conTABLENAME="ManageRolesPermissions"
const DeleteTablename="RolesPermissions"
sConnForum =Application("DSN")
l_register=array(0,1,1,1,1)
l_display=array(1,1,1,1,1)
l_modify=array(0,0,1,1,1)
const langAdminTitle	= "Browser Role-Permission"
'const langAdminCloseWindow	= "Close Window"
Const langNewRecord		= "New R-P"
Const langRecordList	= "R-P List"
Const langSubmitNewRecord = "Submit New R-P"
Const langUpdateRecord = "Update the Record"
'Const langGoBack			= "Go Back"
'Const langDelete			= "Delete"
const langResponseAfterPostSave="Successfully add a new M-P mapping"
