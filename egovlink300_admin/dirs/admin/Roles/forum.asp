...
response.write "<table border=0 cellpadding=5 class='tablelist' cellspacing=1 align=center width=500 bgcolor='" & cForumBgColor & "'>"
response.write "<tr>"
...
next
response.write " <td>Permissions</td>"
response.write "</tr>"
...
response.write "<tr>"& _
  ...
  Next
 response.write "<td><a  HREF=javascript:openWin2('ManageRolePermission.asp?roleid="&RA(IDCol,i)&"','_blank')>&nbsp;Edit</a></td>"
  response.write " </tr>"
next     
...
"resizable,width=400,height=450");
}
</script>
