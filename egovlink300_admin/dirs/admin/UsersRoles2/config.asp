<%
' The NewPost is kind of different from the others. So, form is also different
' I add the automaticlly added list
dim conTABLEFIELDS()
dim l_length()
dim l_type()
...
const cPageSize =10
const IDCol=0
conTABLENAME="AllUsersRoles"
sConnForum =Application("DSN")
l_register=array(0,1,1,1,1)
l_display=array(1,1,1,1,1)
l_modify=array(0,1,1,1,1)
const langAdminTitle	= "Manage Users-Roles(Display All User IDS)"
'const langAdminCloseWindow	= "Close Window"
Const langNewRecord		= "New U-R"
Const langRecordList	= "U-R List"
Const langSubmitNewRecord = "Submit New Mapping"
Const langUpdateRecord = "Update the Mapping"
'Const langGoBack			= "Go Back"
'Const langDelete			= "Delete"
const langResponseAfterPostSave="Successfully add the mapping"
