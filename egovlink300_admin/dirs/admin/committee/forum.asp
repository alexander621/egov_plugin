...
'-------------- Save new record to the database, 
		case ActNewPostSave
		response.write "<B>"&langAdminCommitteeAdded&"</B><br>"
        set of = new DBActionClass
			of.AddNew
			destroy of	
...
deleteurl=thisname&"?iofaction="&ActDelete&"&groupid="&request.querystring("groupid")
...
response.write "<tr>"& _
   ...
   " <td><a href='"&editurl&"&"&conTABLEFIELDS(0)&"="&RA(0,i)&"'>"&RA(0,i)&"</a></td>"
...
set cDB = new DBClass
	cDB.Open sConnForum
response.write "<h4>"&langUpdate&" "&langCommittee&"</h4>"
