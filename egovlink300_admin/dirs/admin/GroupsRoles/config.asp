...
const cPageSize =10
const IDCol=0
conTABLENAME="GroupsRoles"
sConnForum =Application("DSN")
l_register=array(0,1,1,1)
l_display=array(1,1,1,1)
l_modify=array(0,1,1,1)
const langAdminTitle	= "Manage Group-Roles"
'const langAdminCloseWindow	= "Close Window"
Const langNewRecord		= "New G-R"
Const langRecordList	= "G-R List"
