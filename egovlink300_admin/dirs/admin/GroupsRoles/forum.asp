...
'----------------------------------
      extraStr="&nbsp;"
			...
			strSQL = "select groupname as extra from groups where groupid="&RA(j,i)
...
select case j
case 1
openstr="select groupid as id,(groupname+','+cast(orgid as varchar(4))) as description from groups"
case 2
openstr="select roleid as id,(rolename+','+cast(orgid as varchar(4))) as description from roles"
case else
exit sub
end select
