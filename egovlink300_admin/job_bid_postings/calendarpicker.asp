...
//      window.opener.document.getElementById("<%=request("updatefield")%>_hour").disabled=false;
//      window.opener.document.getElementById("<%=request("updatefield")%>_min").disabled=false;
//      window.opener.document.getElementById("<%=request("updatefield")%>_ampm").disabled=false;
      window.opener.document.<%=request("updateform")%>.<%=request("updatefield")%>.focus();
      window.close();
    }
  //-->
  </script>
