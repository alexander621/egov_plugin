<%
	' This menu is set up to handle the special case of the online documents having a frameset.
	' It is not able to display a dropdown menu.
%>
<!-- menu script itself. you should not modify this file -->
<script language="JavaScript" src="<%=sLevel%>menu/menu_scripts/documents_menu.js"></script>
...
Sub DisplayFeatureListNav( sLevel )
	...
	sSQL = sSQL & " where F.feature = 'home' and F.featuretype = 'N' "
	...
	If Not oFeatures.EOF Then
		' There is only the home menu item at the top most position
		response.write "var MENU_ITEMS = [['" & oFeatures("FeatureName") & "', '" & sLevel & oFeatures("adminurl") & "'],];" & vbcrlf 
