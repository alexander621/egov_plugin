...
public partial class action_line_pdfview_fraud : System.Web.UI.Page
{
...
//        Response.End( );
        ...
        MyPageEventHandlerF eh = new MyPageEventHandlerF( );
        ...
        document.Add( createSubTitle( "Details", document ) );
...
public class MyPageEventHandlerF : PdfPageEventHelper
{
    ...
    public override void OnEndPage( PdfWriter writer, Document document )
    {
        ...
        // the main title
        c = new PdfPCell( new Phrase( "Fraud, Abuse, and Waste Form", arialTitle ) );
