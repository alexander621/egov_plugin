...
public partial class action_line_pdfview_job_application : System.Web.UI.Page
{
...
//        Response.End( );
        ...
        MyPageEventHandlerJA eh = new MyPageEventHandlerJA( );
        ...
        //document.Add( createSubTitle( "Issue Location", document ) );
        ...
        document.Add( createSubTitle( "Application Details", document ) );
    ...
    public string getQuestionsAndAnswers( string _RequestId )
    {
        ...
        while (myReader.Read( ))
        {
            ...
            if (answer != "")
	    {
		//if (answer.Substring(answer.Length-2,2) == "\n")
			//answer = answer.Remove(answer.Length-2,2);
		if (answer.LastIndexOf(Environment.NewLine) == answer.Length-2)
			answer = answer.Remove(answer.Length-2,2);
    ...
    public string cleanForPDF( string _Value )
    {
        ...
        cleanValue = _Value;
        cleanValue = cleanValue.Replace( "<p>", "" ).Replace( "</p>", "" ).Replace( "<P>", "" ).Replace( "</P>", "" );
	cleanValue = cleanValue.Replace("<br><br> ","<br>").Replace("</br></br> ","<br>").Replace("<BR><BR> ","<br>").Replace( "<br>", "\n" );
	cleanValue = cleanValue.Replace("<br><br>","<br>").Replace("</br></br>","<br>").Replace("<BR><BR>","<br>").Replace( "<br>", "\n" );
        cleanValue = cleanValue.Replace( "<br/>", "\n" ).Replace( "<br />", "\n" ).Replace( "&lt;br />", "\n" ).Replace( "&lt;BR />", "\n" ).Replace( "&lt;br/>", "\n" ).Replace( "&lt;BR>", "\n" ).Replace( "</BR>", "\n" ).Replace( "</br>", "\n" ).Replace( "<BR>", "\n" ).Replace( "</b>", "" );
        cleanValue = cleanValue.Replace( "<b>", "" ).Replace( "</B>", "" ).Replace( "<B>", "" ).Replace( "<u>", "" ).Replace( "</u>", "" ).Replace( "<U>", "" ).Replace( "</U>", "" );
        cleanValue = cleanValue.Replace( "&quot;", "\"" ).Replace( "default_novalue", "" );
...
public class MyPageEventHandlerJA : PdfPageEventHelper
{
    ...
    public override void OnEndPage( PdfWriter writer, Document document )
    {
        ...
        // the main title
        c = new PdfPCell( new Phrase( "Job Application", arialTitle ) );
