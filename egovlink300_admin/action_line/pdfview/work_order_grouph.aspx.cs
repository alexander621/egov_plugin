...
public partial class action_line_pdfview_work_order_grouph : System.Web.UI.Page
{
    int orgId = 0;
    ...
    public void showWorkOrder( string _RequestId, ref Document _Document, ref PdfWriter _Writer )
    {
        ...
        MyPageHeaderWOGH eh = new MyPageHeaderWOGH( );
...
public class MyPageHeaderWOGH : PdfPageEventHelper
{
