...
'--------------------------------------------------------------------------------------------------
Function  GetReservationDetail( ByRef sBody )
...
' FUNCTION GETWAIVERTEXT(IWAIVERID)
'--------------------------------------------------------------------------------------------------
Function GetAdditionalWaivers(sMask)
...
Function  GetReservationDetailAdmin(sBody)
	...
	sSQL = "Select * FROM egov_facilityschedule INNER JOIN egov_facility ON egov_facilityschedule.facilityid = egov_facility.facilityid where facilityscheduleid = '" & request("ReservationID") & "'"
	...
	sSQL = "SELECT egov_facility_field_values.facilityvalueid, egov_facility_field_values.fieldid, egov_facility_field_values.fieldvalue, egov_facility_field_values.paymentid, egov_facility_fields.fieldid AS Expr1, egov_facility_fields.fieldname, egov_facility_fields.fieldtype,                       egov_facility_fields.facilityid, egov_facility_fields.sequence, egov_facility_fields.isrequired, egov_facility_fields.fieldchoices FROM         egov_facility_field_values INNER JOIN                       egov_facility_fields ON egov_facility_field_values.fieldid = egov_facility_fields.fieldid WHERE     (egov_facility_field_values.paymentid = '" & request("ReservationID") & "') ORDER BY egov_facility_field_values.paymentid, egov_facility_field_values.fieldid"
