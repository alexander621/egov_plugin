				...
				response.write "<tr><td>&nbsp;</td></tr>" & vbcrlf
       			...
       			case "8"
					...
					if iFormID = "17890" and oQuestions("prompt") = "Start Date" then
						sFirstDate = FindNextRyeBusinessDay("1/1/2015")


						response.write "<tr><td><input name=""fmquestion" & iQuestionCount & """ value=""" & sFirstDate & """ type=""text"" style=""width:300px;"" maxlength=""" & lcl_text_field_length & """ /></td></tr>"& vbcrlf
