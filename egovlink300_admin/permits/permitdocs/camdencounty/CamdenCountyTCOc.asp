...
<html>
	...
	<center><h2>
	TEMPORARY CERTIFICATE OF COMPLIANCE</h2></center>
	<br />
	<br />
...
<br />
<br />
Period of time (Dates): <%=strPeriodOfTime%>
<br />
<br />
Portion of Building: <%=strPortionOfBuilding%>
<br />
<br />
<br />
<br />
...
Use Description/Type of Occupancy:&nbsp;&nbsp;&nbsp;<%=oRs("permittypedesc")%>
<br />
<br />
<br />
<br />
