...
<html>
	...
	<%
		strTitle = "CERTIFICATE OF COMPLIANCE"
		'permitid=3403&permitdoc=0&permitdocumentid=3408
	...
	<body onload="window.print();">
		...
		The changes or work authorized by the permit issued for this project have been inspected and approved as noted above. The issuance of this Certificate of Compliance acknowledges the completeness and appropriateness of the changes and or work authorized by the above referenced permit and with reference to any conditions noted above.
		<hr />
		<!--#include file="header.asp"-->
		<table>
			<tr>
				...
				%>
					...
					<tr>
						<td colspan="4">
							<b>Notes:</b><br />
							<%
							sSQL = "SELECT externalcomment " _
  								& " FROM egov_permitlog " _
								& " WHERE permitinspectionid = " & oRsI("permitinspectionid")
							set oRsNote = Server.CreateObject("ADODB.RecordSet")
							oRsNote.Open sSQL, Application("DSN"), 3, 1
							Do WHile Not oRsNote.EOF
								response.write oRsNote("ExternalComment") & "<br />"
								oRsNote.MoveNext
							loop
							oRsNote.Close
							Set oRsNote = Nothing
