...
Dim sSuccessMsg, sUpFrontAmount, iFeeReportingTypeId
...
If iPermitFeeTypeid = CLng(0) Then 
	...
	sSql = sSql & " permitfeemethodid, isconstructiontypefee, isbuildingpermitfee, atleastqty, notmorethanqty, baseamount, unitqty, unitamount, "
	sSql = sSql & " upfrontamount, feereportingtypeid ) VALUES ( "
	...
	sSql = sSql & "1, 1, 0, 999999999, " & request("baseamount") & ", " & request("unitqty") & "," & request("unitamount") & ", "
	sSql = sSql & sUpFrontAmount & ", " & iFeeReportingTypeId & " )"
	iPermitFeeTypeid = RunIdentityInsert( sSql ) 
	sSuccessMsg = "Construction Type Fee Created"
Else 
	...
	sSql = sSql & ", baseamount = " & request("baseamount")
	sSql = sSql & ", unitqty = " & request("unitqty") & ", unitamount = " & request("unitamount")
...
response.redirect "permitconstructiontypefeeedit.asp?permitfeetypeid=" & iPermitFeeTypeid & "&success=" & sSuccessMsg
