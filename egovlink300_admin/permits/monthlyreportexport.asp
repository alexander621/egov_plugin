...
Dim dPreviousPen, dYTDCert, dPreviousCert, iInclude
...
sSql = "SELECT P.permitid, P.issueddate, ISNULL(P.residentialunits,0) AS residentialunits, "
...
sSql = sSql & sIsVoided
sSql = sSql & " UNION ALL "
sSql = sSql & " SELECT P.permitid, P.issueddate, 0 AS residentialunits, "
...
If Not oRs.EOF Then 
	...
	response.write vbcrlf & "<tr height=""30""><th>Permit #</th><th>Issued Date</th><th>Scope of Work</th><th>Address</th><th>Residential Units</th><th>Est. Cost</th>"
