...
<%
 ...
 'Do not build the following styles if the user is accessing the screen from a mobile device.
  ...
  buildStyles_CL_PageHeader lcl_pageheader_bgcolor, lcl_pageheader_fonttype, lcl_pageheader_fontcolor
...
<div><div id='outerdivv' style="width:540px; height:74px; overflow:hidden; position:relative; border: none; "><iframe id='inneriframe' src='http://chat.amyiris.com/widget/?conversation.app=egov' frameBorder='0' style="position:absolute; top:0px; left:0px; width:1280px; height:1200px; border: 1px solid #000000;"></iframe></div></div>
<%
 ...
 'BEGIN: Footer ---------------------------------------------------------------
  ...
  response.write "                              <a href=""" & oOrg.GetOrgURL()  & """ class=""topBarOption"">" & lcl_cityhome_label & "</a> |" & vbcrlf
  response.write "                              <a href=""" & oOrg.GetEgovURL() & """ class=""topBarOption"">E-Gov Home</a>" & vbcrlf
                                                ShowPublicDefaultFooterNav iorgid, 2, lcl_isEgovHomePage
  response.write "                              <br />" & vbcrlf

  if oOrg.OrgHasDisplay("privacy policy") then
     response.write "<a href=""" & oOrg.GetEgovURL() & "/privacy_policy_display.asp"" class=""topBarOption""><strong>Privacy Policy</strong></a> | " & vbcrlf
  end if

  if oOrg.OrgHasDisplay("refund policy") then
     response.write "<a href=""" & oOrg.GetEgovURL() & "/refund_policy.asp"" class=""topBarOption"">Refund Policy</a> | " & vbcrlf
  end if

  response.write "                              <a href=""user_login.asp"" class=""topBarOption"">Login</a>	| " & vbcrlf
  response.write "                              <a href=""register.asp"" class=""topBarOption"">Register</a>" & vbcrlf
