...
%>
	<div>
	<input type="button" class="button" onclick="javascript:tree.expandAll();" value="Expand all" /> &nbsp;
    <input type="button" class="button" onclick="javascript:tree.collapseAll();" value="Collapse all" />
	</div>
<%
	
	' BEGIN FOLDER TREE
'	response.write vbcrlf & "<div id=""treeDiv1"">"
'	response.write "<img src=""../images/loading.gif"" border=""0"" /> Loading... Please Wait."
...
<script>
<!--
	//doAjax('doctreepull.asp', '', 'RefreshPageAfterPull', 'get', '0');
	treeInit();

	function RefreshPageAfterPull( sReturn )
	{
		$("treeDiv1").innerHTML = sReturn;
		treeInit();
	}
