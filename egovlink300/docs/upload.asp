...
objUpload.MaxFileSize = (4096000 * 4) '4 MB
...
Else
  ...
  strPath = objUpload.Form("txtTopic")
...
IF blnSuccessful = "Yes" Then
	...
	Response.Redirect "adduploadtodb.asp?strTitle=" & strFileName & "&task=ADD&method=upload&Message=" & strMessage & "Upload=" & blnSuccessful
Else
	' UPLOAD WAS NOT SUCCESFUL RETURN TO ADD PAGE WITH MESSAGE
	Response.Redirect "addarticle.asp?strTitle=" & strFileName & "&task=ADD&method=upload&Message=" & strMessage  
End If
