...
/// </summary>
	...
	if(Request.Form["dir"] == null || Request.Form["dir"].Length <= 0)
		dir = "\\egovlink300_docs\\custom\\pub\\" + common.GetVirtualDirectyName( HttpContext.Current.Request.ServerVariables["URL"].ToLower( ) ) + "\\";
	else
	...
	OrgUrl = "/egovlink300_docs/custom/pub/" + common.GetVirtualDirectyName( HttpContext.Current.Request.ServerVariables["URL"].ToLower( ) ) + "/";
	...
	foreach ( System.IO.DirectoryInfo di_child in di.GetDirectories( ) )
	{
		if ( dir + di_child.Name != OrgUrl + "attachments" && dir + di_child.Name != OrgUrl + "pdf_forms" && dir + di_child.Name != OrgUrl + "postings_bids" )
		{
			...
			HasInternalSecurity = common.FolderHasInternalSecurity( dir.Replace( "egovlink300_docs", "public_documents300" ) + di_child.Name );
			...
			if ( ! HasInternalSecurity || common.UserCanViewSecureFolder( UserId, dir.Replace( "egovlink300_docs", "public_documents300" ) + di_child.Name ) )
			{
				...
				if ( common.FolderHasRestrictedPublicAccess( dir.Replace( "egovlink300_docs", "public_documents300" ) + di_child.Name ) )
