...
/*    var f=document.getElementById("inneriframe");
    ...
    /*var t=document.getElementByName("textin");
    t.focus(); 
...
<%
 ...
 'Find the length of the page header minus the AddThis button width
  ...
  response.write "<div><div id='outerdiv'><iframe id='inneriframe' src='http://10.8.8.50:8000/page/tiny2/' frameBorder='0'></iframe></div></div>"
