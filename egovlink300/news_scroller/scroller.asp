...
'------------------------------------------------------------------------------
 ...
 sSQL = sSQL & " AND UPPER(newstype) = 'SCROLLER' "
 ...
 if not oNewItems.eof then
   	do while not oNewItems.eof
  	   	sScroller = sScroller & vbcrlf & " pausecontent[" & x & "]= ""<div class='scrollertitle'>" & oNewItems("itemdate") & " " & JavaScriptSafe(oNewItems("itemtitle"))
