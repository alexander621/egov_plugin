...
<TR><TD VALIGN=TOP>
	...
	<tr>
		...
		<td valign=top style="background:url('img/action_icon.jpg');background-repeat: no-repeat;background-position:bottom right;">
			<table cellspacing=0 cellpadding=0 border=0 class=box>
			  <tr><td valign=top class=box_edge><img src="custom/images/<%=sorgVirtualSiteName%>/left_side.jpg"></td><td height=20 class=box_header><%=sOrgActionName%></td><td valign=top class=box_edge ><img src="custom/images/<%=sorgVirtualSiteName%>/right_side.jpg"></td></tr>
		...
		<td valign=top>
			<table cellspacing=0 cellpadding=0 border=0 class=box>
			  <tr><td valign=top class=box_edge><img src="custom/images/<%=sorgVirtualSiteName%>/left_side.jpg"></td><td height=20 class=box_header><%=sOrgPaymentName%></td><td valign=top class=box_edge><img src="custom/images/<%=sorgVirtualSiteName%>/right_side.jpg"></td></tr>
			  <tr>
				<td valign=top style="background:url('img/payment_icon.jpg');background-repeat: no-repeat;background-position:bottom right;" colspan=3 class=box_content>
	...
	<%If blnOrgDocument Then%>
		<td valign=top style="background:url('img/document_icon.jpg');background-repeat: no-repeat;background-position:bottom right;">
			<table cellspacing=0 cellpadding=0 border=0 class=box>
			  <tr><td><img src="custom/images/<%=sorgVirtualSiteName%>/left_side.jpg"></td><td height=20 class=box_header><%=sOrgDocumentName%></td><td><img src="custom/images/<%=sorgVirtualSiteName%>/right_side.jpg"></td></tr>
			  <tr><td valign=top colspan=3 class=box_content>
				<ul style="padding-top:7px;">
					<!--#Include file="docs/menu/menuHome.asp"-->
				</ul>
...
<%If blnOrgCalendar Then%>
		<td valign=top>
			<table cellspacing=0 cellpadding=0 border=0 class=box>
			  <tr><td><img src="custom/images/<%=sorgVirtualSiteName%>/left_side.jpg"></td><td height=20 class=box_header><%=sOrgCalendarName%></td><td><img src="custom/images/<%=sorgVirtualSiteName%>/right_side.jpg"></td></tr>
...
<%End If%>
	...
	<tr>
		<td colspan=2>
			<table cellspacing=0 cellpadding=0 border=0 class=box>
			  <tr><td><img src="custom/images/<%=sorgVirtualSiteName%>/left_side.jpg"></td><td height=20 class=box_header>Log In</td><td><img src="custom/images/<%=sorgVirtualSiteName%>/right_side.jpg"></td></tr>
			  <tr>
