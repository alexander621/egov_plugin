    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.ServerVariables["REMOTE_ADDR"] == "24.106.89.6" || Request.ServerVariables["REMOTE_ADDR"].Substring(0, 7) == "10.0.8.")
        {
            ...
            while ( myReader.Read() ) 
            {
                ...
                ErrMsg += "<div class=\"errorbox\"><strong>Error Date:</strong> " + myReader["errordatetime"];
                ErrMsg += "<br /><strong>Category:</strong> " + myReader["category"] + "</div>";

                ErrMsg += "<strong>Error Object Information</strong><br />";
                ErrMsg += "<div class=\"errorbox\"><strong>Description:</strong> " + myReader["description"];
                ErrMsg += "<br /><strong>File:</strong> " + myReader["errorfile"];
                ErrMsg += "<br /><strong>Host:</strong> " + myReader["httphost"];
                ErrMsg += "<br /><strong>Remote Address:</strong> " + myReader["remoteaddress"] + "</div>";

                ErrMsg += "<strong>Stacktrace</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["source"] + "</div>";

                ErrMsg += "<strong>Browser Information</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["browserinformation"] + "</div>";

                ErrMsg += "<strong>Application Collection</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["applicationcollection"] + "</div>";

                ErrMsg += "<strong>Request Form Collection</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["requestformcollection"] + "</div>";

                ErrMsg += "<strong>Querystring Collection</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["requestquerystringcollection"] + "</div>";

                ErrMsg += "<strong>Session Collection</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["sessioncollection"] + "</div>";

                ErrMsg += "<strong>Cookies Collection</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["cookiescollection"] + "</div>";

                ErrMsg += "<strong>Server Variable Collection</strong><br />";
                ErrMsg += "<div class=\"errorbox\">" + myReader["servervariablescollection"] + "</div>";
