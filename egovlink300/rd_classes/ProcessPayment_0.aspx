...
/// 
    ...
    public string ProcessPointAndPayTransaction( PayeeInfo _PayeeInfo, int _ProcessControlNumber, string _OrgId, double _ChargeableTotal )
    {
		...
		common.makePaymentLogEntry( ref _ProcessControlNumber, _OrgId, "public", "classes/events", "chargeexpirationmmyy " + _PayeeInfo.ExpMonth.ToString( "00" ) + expYear );
    ...
    public string processSuccessfulTransaction(string _OrgId, 
                                               string _SessionId, 
                                               int _BuyerUserId, 
                                               double _CartTotal,
                                               double _ChargeableTotal,
                                               double _AccountCredit,
                                               string _FeeAmount,
                                               double _CurrentAccountBalance,
                                               string _AuthCode,
                                               string _PNRef,
                                               string _RespMsg,
                                               string _OrderNumber,
                                               ...
                                               int _ProcessControlNumber)
    {
        ...
        string paymentId = common.makeTheJournalEntry(_OrgId.ToString( ), 
                                                      paymentLocationId.ToString( ), 
                                                      _BuyerUserId.ToString( ), 
                                                      _CartTotal, 
                                                      journalEntryTypeId.ToString( ), 
                                                      journalNotes, 
                                                      "0", 
                                                      "NULL");

        common.makePaymentLogEntry(ref _ProcessControlNumber, 
                                   _OrgId, 
                                   "public", 
                                   "classes/events", 
                                   "Journal Entry Made: " + paymentId);
