<%@ Page Language="C#" AutoEventWireup="true" CodeFile="class_receipt.aspx.cs" Inherits="rd_classes_class_receipt" %>
...
<%
    ...
    egov_navigation.egovsection = "PRINTBUTTONONLY";
    ...
    Session["RedirectPage"]    = "rd_classes/class_receipt.aspx?paymentid=" + Request.QueryString["paymentid"];
    Session["RedirectLang"]    = "Return to view receipt";
    Session["LoginDisplayMsg"] = "Please log in before viewing receipt";
    Session["DisplayMsg"]      = "";
    Session["ManageURL"]       = "";
%>
<html lang="en">
<head id="Head1" runat="server">
  ...
  <link type="text/css" rel="Stylesheet" href="styles_receiptprint.css" media="print" />
...
<div id="wrapper_body">
  ...
  <div id="wrapper_content">
    <div id="content">
      <% displayReceipt(Convert.ToInt32(sOrgID)); %>
    </div>
  </div>
