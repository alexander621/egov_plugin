...
sub checkAddress(iOrgID, iStreetNumber, iStreetName, iAddressType)
 ...
 if sAddressType = "LARGE" then
    ...
    sSQL = sSQL & " AND (ltrim(rtrim(residentstreetname)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetname)) + ' ' + ltrim(rtrim(streetsuffix)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetname)) + ' ' + ltrim(rtrim(streetdirection)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetname)) + ' ' + ltrim(rtrim(streetsuffix)) + ' ' + ltrim(rtrim(streetdirection)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetprefix)) + ' ' + ltrim(rtrim(residentstreetname)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetprefix)) + ' ' + ltrim(rtrim(residentstreetname)) + ' ' + ltrim(rtrim(streetsuffix)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetprefix)) + ' ' + ltrim(rtrim(residentstreetname)) + ' ' + ltrim(rtrim(streetdirection)) = '" & sStreetName & "' "
    sSQL = sSQL & " OR ltrim(rtrim(residentstreetprefix)) + ' ' + ltrim(rtrim(residentstreetname)) + ' ' + ltrim(rtrim(streetsuffix)) + ' ' + ltrim(rtrim(streetdirection)) = '" & sStreetName & "'"
    sSQL = sSQL & ")"
 else
