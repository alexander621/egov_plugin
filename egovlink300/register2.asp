...
<div class=groupsmall2>
	...
	<table>
		...
		<tr><td class=label align="right">
			...
			<% DisplayResidentAddresses "R",iorgid %>
		</td></tr>
		<tr><td class=label align="right">
			Street Not Listed:
		</td><td><input type="text" value="<%=request.form("egov_users_useraddress")%>" name="egov_users_useraddress" style="width:300;" maxlength="100"></tr>
		<tr><td class=label align="right">
			Business Name:
		</td><td>
		...
		<tr><td class=label align="right">
			...
			<% DisplayResidentAddresses "B",iorgid %>
		</td></tr>
		<tr><td class=label align="right">
			Street Not Listed:
		</td><td><input type="text" value="<%=request.form("egov_users_useraddress")%>" name="egov_users_useraddress" style="width:300;" maxlength="100"></tr>
...
'------------------------------------------------------------------------------------------------------------
' SUB DISPLAYRESIDENTADDRESSES(STYPE,IORGID)
'------------------------------------------------------------------------------------------------------------
Sub DisplayResidentAddresses(sType,iorgid)
		
	sSQL = "SELECT * FROM egov_residentaddresses where orgid='" & iorgid & "' and residenttype='" & sType & "'"
	...
	If NOT oAddressList.EOF Then
		...
		response.write "<option value=""0000"">Please select street..."
		
		Do While NOT oAddressList.EOF 
			response.write "<option value=""" &  oAddressList("residentstreetnumber") & " " & oAddressList("residentstreetname")  & """>" & oAddressList("residentstreetnumber") & " " & oAddressList("residentstreetname") & "</option>"
