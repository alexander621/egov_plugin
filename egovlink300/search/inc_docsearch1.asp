...
' BUILD DISPLAY TABLE WITH MATCHED DOCUMENT INFORMATION
 ...
 ' Graphically indicate rank of document with list of stars (*'s).
	...
	response.write "DocTitle = " & RS("DocTitle") & "<br />"
	response.write "filename = " & RS("filename") & "<br />"
	response.write "path = " & RS("path") & "<br />"
	response.write "size = " & RS("size") & "<br />"
	response.write "vpath = [" & RS("vpath") & "]" & "<br />"
	RS.MoveNext
