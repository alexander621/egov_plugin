...
'		strDots = ""
	...
	sURLLink = "/public_documents300/" & GetVirtualDirectyName() & "/published_documents" & sDisplayLink
		If Len(sDisplayLink) > 35 Then
			sDisplayLink = "..." & Right(sDisplayLink,35)
		End If 
		...
		if VarType(RS("DocTitle")) = 1 or RS("DocTitle") = "" then
			...
			strDisplayTable = strDisplayTable & "NO TITLE<br><font color=black>Location:</font> <nobr>" & sDisplayLink & "</nobr></a>"
		else
			strDisplayTable = strDisplayTable & "<a href="""& sURLLink & """ class=""RecordTitle"">"
			strDisplayTable = strDisplayTable & UCASE(Server.HTMLEncode(RS("DocTitle"))) & "<br><font color=black>Location:</font> <nobr>" & sDisplayLink & "</nobr></a>"
		end if
