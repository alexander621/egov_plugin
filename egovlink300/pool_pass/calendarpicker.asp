    ...
    <tr height="30">
      <td bgcolor="#336699" align="center" colspan="7">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" style="border:0px;" nowrap>&nbsp;<img src="../images/arrow_back.gif" align="absmiddle">&nbsp;<a href="calendarpicker.asp?ToFrom=<%=Request("ToFrom")%>&date=<%= SubtractOneMonth(dDate) %>"><FONT face="Arial" COLOR=#ffffff SIZE="1">Previous Month</FONT></A></td>
            ...
            <td width="15%" align="right" style="border:0px;" nowrap><A HREF="calendarpicker.asp?ToFrom=<%=Request("ToFrom")%>&date=<%= AddOneMonth(dDate) %>"><FONT face="Arial" COLOR=#ffffff SIZE="1">Next Month</FONT></A>&nbsp;<img src="../images/arrow_forward.gif" align="absmiddle">&nbsp;</td>
          </tr>
        </table>
      </td>
    </tr>
