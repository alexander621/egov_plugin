...
'        end if
           ...
           if lcl_orghasfeature_issue_location then
              lcl_address = ""
                 ...
                 getAddressInfoNew lcl_orghasfeature_large_address_list, lcl_orgid, sStreetNumber, sStreetName, _
                                   sNumber, sPrefix, sAddress, sSuffix, sDirection, sLatitude, sLongitude, _
                                   sCity, sState, sZip, sCounty, sParcelID, sListedOwner, sLegalDescription, _
 ...
 'END: Cycle through all of the fields in the section. ------------------------
  response.redirect "maintain_dmt_section.asp?dmid=" & lcl_dmid & "&sectionid=" & lcl_sectionid & "&success=SU"
%>